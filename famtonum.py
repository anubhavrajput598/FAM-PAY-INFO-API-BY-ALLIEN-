...
# Credits
# @allien07_| telegram allien_mods7
...
def fetch_fampay_pii(upi_id):
    ...
    try:
        ...
        final_output = {
            ...
            "credits": "@allien07_ | telegram allien_mods7"
        }
...
def get_fampay_pii():
    ...
    if "error" in result:
        ...
        result["credits"] = "@allien07_ | telegram allien_mods7" # Add credits to error responses too
